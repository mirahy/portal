...
Gov BR is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how Gov BR elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Gov BR in the search form and press the 'Enter' key on your keyboard.
...
Gov BR WordPress Theme, 2020-2023 WordPress.org
Gov BR is distributed under the terms of the GNU GPL.
...
Gov BR is derived from Twenty Twenty One, Copyright (C) 2020-2023 WordPress.org.

Gov BR is also based on:
