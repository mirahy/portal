                ...
                <div class="menu-header">
                    ...
                    <div class="menu-title">
                        ...
                        <span class="custom-logo-link">
                            <img class="logo-navigation" src="<?php echo get_home_url().'/wp-content/themes/govbr/assets/images/logo-ufgd.png' ?>" alt="">
                        </span>
                        <span class="title-navigation"><?php echo get_bloginfo( 'name' ); ?></span>
                    </div>
                </div>
                    ...
                    <?php
                        wp_nav_menu(
                            array(
                                ...
                                'items_wrap'      => '<nav class="%2$s" id="primary-menu-list">%3$s</nav>',
                                'fallback_cb'     => false,
                                'walker'          => new Gov_BR_Walker_Nav_Menu(),
                            )
                        );
                    ?>
                <?php endif; ?>
